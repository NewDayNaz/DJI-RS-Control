// CAN controller for the Seeed XIAO CAN Bus Expansion Board (MCP2515 over SPI +
// SN65HVD230). The hat does not connect the ESP32-C3 TWAI pins.
//
// The DJI R SDK packet layer (dji_can_protocol.*) is transport-agnostic; this
// file is the only place that talks to silicon.
#pragma once
